...
#mysqlimport -u dbmeteodb --password=dbmeteodb --fields-terminated-by=';' -c datetime,jour,pmptp dbmeteodb pm10.csv
...
mysql -u dbmeteodb --password=dbmeteodb dbmeteodb -e "load data infile '~/lovy/data/aeronet/aeronet.txt' into table aotbarbade fields terminated by ',' ignore 5 lines" 
