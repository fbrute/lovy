...
require 'trajectory_stat_d3_pm10s_dates_picnum'

describe TrajectoryStatD3Pm10sDatesPicnum do
  before(:example) do
    ...
    d3dates = IO.readlines(File.expand_path(d3dates_filepath)).each(&:chomp!).uniq
