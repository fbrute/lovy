...
files = [
        os.path.join(dir_path, 'guadeloupe_jnp_ma_tephi_data_inf_28.txt'),
        os.path.join(dir_path, 'guadeloupe_ma_faible_tephi_data.txt'),
        os.path.join(dir_path, 'guadeloupe_ma_moyen_tephi_data.txt'),
        os.path.join(dir_path, 'guadeloupe_ma_fort_tephi_data.txt'),

        os.path.join(dir_path, 'puerto_rico_jnp_ma_tephi_data_inf_28.txt'),
        os.path.join(dir_path, 'puerto_rico_ma_faible_tephi_data.txt'),
        os.path.join(dir_path, 'puerto_rico_ma_moyen_tephi_data.txt'),
        os.path.join(dir_path, 'puerto_rico_ma_fort_tephi_data.txt')
        ]
