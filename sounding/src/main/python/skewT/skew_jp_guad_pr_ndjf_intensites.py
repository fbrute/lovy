...
files = [
        os.path.join(dir_path, 'guadeloupe_jnp_ndjf_tephi_data_inf_28.txt'),
        os.path.join(dir_path, 'guadeloupe_ndjf_faible_tephi_data.txt'),
        os.path.join(dir_path, 'guadeloupe_ndjf_moyen_tephi_data.txt'),
        os.path.join(dir_path, 'guadeloupe_ndjf_fort_tephi_data.txt'),

        os.path.join(dir_path, 'puerto_rico_jnp_ndjf_tephi_data_inf_28.txt'),
        os.path.join(dir_path, 'puerto_rico_ndjf_faible_tephi_data.txt'),
        os.path.join(dir_path, 'puerto_rico_ndjf_moyen_tephi_data.txt'),
        #os.path.join(dir_path, 'puerto_rico_ndjf_fort_tephi_data.txt')
        ]
