...
karu_jnp_ndjf_filename = os.path.join('../sql/tephi', 'guadeloupe_jnp_ndjf_tephi_data.txt')
...
karu_jnp_ndjf_data , karu_ndjf_faible_data, karu_ndjf_moyen_data, karu_ndjf_fort_data, sal_data, pr_jnp_ndjf_data, pr_ndjf_faible_data, pr_ndjf_moyen_data = \
tephi.loadtxt(karu_jnp_ndjf_filename, karu_ndjf_faible_filename,karu_ndjf_moyen_filename, karu_ndjf_fort_filename, dunion_filename, pr_jnp_ndjf_filename, pr_ndjf_faible_filename , pr_ndjf_moyen_filename , column_titles = columns)
...
tpg.plot(karu_jnp_ndjf_temps, label='Guadeloupe JNP NDJF ', color='magenta', linewidth=2,linestyle='--', marker='s')
tpg.plot(karu_ndjf_faible_temps, label='Guadeloupe JP NDJF faible intensite ', color='salmon', linewidth=2,linestyle='-', marker='s')
tpg.plot(karu_ndjf_moyen_temps, label='Guadeloupe JP NDJF moyenne intensite ', color='orangered', linewidth=2,linestyle='-', marker='s')
tpg.plot(karu_ndjf_fort_temps, label='Guadeloupe JP NDJF forte intensite ', color='darkred', linewidth=2,linestyle='-', marker='s')

tpg.plot(pr_jnp_ndjf_temps, label='Porto-Rico JNP NDJF ', color='cyan', linewidth=2,linestyle='--', marker='s')
tpg.plot(pr_ndjf_faible_temps, label='Porto-Rico JP NDJF faible intensite ', color='lightskyblue', linewidth=2,linestyle='-', marker='s')
tpg.plot(pr_ndjf_moyen_temps, label='Porto-Rico JP NDJF moyenne intensite ', color='dodgerblue', linewidth=2,linestyle='-', marker='s')
