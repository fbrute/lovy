...
files = [
        os.path.join(dir_path, 'guadeloupe_jnp_mjja_tephi_data.txt'),
        os.path.join(dir_path, 'guadeloupe_jp_mjja_tephi_data.txt'),
        os.path.join(dir_path, 'puerto_rico_jnp_mjja_tephi_data.txt'),
        os.path.join(dir_path, 'puerto_rico_jp_mjja_tephi_data.txt')
        ]
