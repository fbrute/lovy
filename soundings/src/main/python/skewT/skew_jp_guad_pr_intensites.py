...
files = [
        os.path.join(dir_path, 'guadeloupe_jnp_tephi_data_inf_28.txt'),
        os.path.join(dir_path, 'guadeloupe_jp_intensite_faible_tephi_data.txt'),
        os.path.join(dir_path, 'guadeloupe_jp_intensite_moyen_tephi_data.txt'),
        os.path.join(dir_path, 'guadeloupe_jp_intensite_fort_tephi_data.txt'),

        os.path.join(dir_path, 'puerto_rico_jnp_tephi_data_inf_28.txt'),
        os.path.join(dir_path, 'puerto_rico_jp_intensite_faible_tephi_data.txt'),
        os.path.join(dir_path, 'puerto_rico_jp_intensite_moyen_tephi_data.txt'),
        os.path.join(dir_path, 'puerto_rico_jp_intensite_fort_tephi_data.txt')
        ]
