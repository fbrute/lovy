...
files = [
        os.path.join(dir_path, 'guadeloupe_jnp_so_tephi_data_inf_28.txt'),
        os.path.join(dir_path, 'guadeloupe_so_faible_tephi_data.txt'),
        os.path.join(dir_path, 'guadeloupe_so_moyen_tephi_data.txt'),
        os.path.join(dir_path, 'guadeloupe_so_fort_tephi_data.txt'),

        os.path.join(dir_path, 'puerto_rico_jnp_so_tephi_data_inf_28.txt'),
        os.path.join(dir_path, 'puerto_rico_so_faible_tephi_data.txt'),
        os.path.join(dir_path, 'puerto_rico_so_moyen_tephi_data.txt'),
        os.path.join(dir_path, 'puerto_rico_so_fort_tephi_data.txt')
        ]
